...
final class WebGUIModules {
    private static final List<Category> CATEGORIES = List.of(
            ...
            new Category("Render", "视觉", List.of(
                    ...
                    module("Armor Transparency", "装备透明度调整", "Adjust armor transparency for each equipment slot.", "单独调整四个装备槽位的盔甲透明度", "armorTransparency",
                            slider("armorTransparencyHead", "Helmet Transparency", "头盔透明度", 0, 100, 1),
                            slider("armorTransparencyChest", "Chestplate Transparency", "胸甲透明度", 0, 100, 1),
                            slider("armorTransparencyLegs", "Leggings Transparency", "护腿透明度", 0, 100, 1),
                            slider("armorTransparencyFeet", "Boots Transparency", "靴子透明度", 0, 100, 1),
                            check("armorTransparencyShowInCombat", "Show In Combat", "战斗中显示")),
            ...
            new Category("Tool", "工具", List.of(
                    ...
                    module("Held Item Position", "手持物品位置调整", "Adjust first-person main-hand and off-hand item position.", "调整第一人称主手与副手物品的位置", "heldItemPosition",
                            slider("heldItemMainX", "Main Hand X", "主手 X", -1, 1, 0.01),
                            slider("heldItemMainY", "Main Hand Y", "主手 Y", -1, 1, 0.01),
                            slider("heldItemMainZ", "Main Hand Z", "主手 Z", -1, 1, 0.01),
                            slider("heldItemMainRotX", "Main Hand Rotation X", "主手旋转 X", -180, 180, 1),
                            slider("heldItemMainRotY", "Main Hand Rotation Y", "主手旋转 Y", -180, 180, 1),
                            slider("heldItemMainSwingSpeed", "Main Hand Swing Speed", "主手挥手速度", 0, 3, 0.01),
                            slider("heldItemMainAlpha", "Main Hand Alpha", "主手透明度", 0, 100, 1),
                            slider("heldItemOffX", "Off Hand X", "副手 X", -1, 1, 0.01),
                            slider("heldItemOffY", "Off Hand Y", "副手 Y", -1, 1, 0.01),
                            slider("heldItemOffZ", "Off Hand Z", "副手 Z", -1, 1, 0.01),
                            slider("heldItemOffRotX", "Off Hand Rotation X", "副手旋转 X", -180, 180, 1),
                            slider("heldItemOffRotY", "Off Hand Rotation Y", "副手旋转 Y", -180, 180, 1),
                            slider("heldItemOffSwingSpeed", "Off Hand Swing Speed", "副手挥手速度", 0, 3, 0.01),
                            slider("heldItemOffAlpha", "Off Hand Alpha", "副手透明度", 0, 100, 1)),
