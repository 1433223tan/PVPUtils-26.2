...
PVPUtils 从 PVPUtils-v1.6-beta.1 开始引入了内置 IRC 系统。为了保护其核心代码，项目使用了 [PAHP](./docs/PAHP.zh-CN.md) 进行保护，相关代码不进行公开。GitHub 仓库依然保持除 IRC 以外所有功能；对于第三方平台则发布无 IRC 版本，需要使用 IRC 的用户可前往 QQ 群进行获取。

## 简介

PVPUtils 是一款面向 Minecraft 26.2 Fabric 的客户端辅助模组，为原版游戏带来了实用的生存与 PVP 小工具，以及大量美观的视觉组件。所有界面与视觉元素均由 Skija 强力驱动，兼顾精致观感与流畅性能。同时本模组支持自动更新，您无需手动前往模组平台查看是否有更新，当然您也可以使用指令手动检查更新。

## 特点

PVPUtils 内置了大量对于 PVP 和生存来说十分实用的功能。由于功能较多，本模组将其分为几个大块：战斗、视觉、主题、工具、优化、其他。这些功能包括优美的 HUD 组件、防砍动画、动态模糊、输入法冲突修复、方块数量显示、目标信息显示等丰富内容，具体功能请下载模组自行体验。
...
PVPUtils 改变了这一现状。它是一个开源的客户端模组，您可以在遵守本项目非商业源码开放许可证的前提下查看、学习和修改。它整合了大部分 PVP 与生存中常见的辅助与优化功能，让您只需安装一款模组，即可获得多款模组带来的完整体验。同时，作为客户端模组，您也可以自由搭配其他模组来定制属于自己的游戏体验，PVPUtils 也在持续适配和兼容大多数主流模组。

## 兼容性

模组目前仅兼容 Minecraft 26.2 Fabric，支持 Windows 10 及以上平台，暂不支持手机与布吉岛。不过得益于模组开源的性质，已有社区版实现了对相关平台的支持。
...
6. 该模组现在不兼容 Lunar Client。其他第三方客户端尚未经过全面测试，可能会存在问题
